...
def lBayesHLR(theta, x, y, lambda0=0.01):
    ...
    term2=-1/(2*sigma2)*alpha**2-1/(2*sigma2)*beta@beta-len(y)/2*np.log(sigma2)-lambda0*sigma2
    prob1=term1+term2
